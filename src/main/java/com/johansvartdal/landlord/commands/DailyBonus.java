...
private Main plugin;
	...
	private void updateStreak (Player player, int yesterdaysMultiplier) {
		...
		Tools.tellPlayer(player, LangDict.getString("bonus.justCollectedBonus") + Tools.formatCurrency(todaysBonus) + " (" + yesterdaysMultiplier + LangDict.getString("generalSentenceParts.days") + ")", ChatColor.GREEN);
