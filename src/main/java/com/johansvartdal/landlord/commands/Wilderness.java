...
import com.johansvartdal.landlord.playerevents.*;
...
public class Wilderness implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if (args.length == 0) {
            ...
            Tools.printMenuOption(player, "/wilderness", "world (" + Tools.formatCurrency(LevelManager.getWildernessPrice()) + ")");
            if (LevelManager.featureUnlocked("wildnether")) {
                Tools.printMenuOption(player, "/wilderness", "nether " + "(" + Tools.formatCurrency(LevelManager.getNetherWildernessPrice()) + ")");
            }

            if (LevelManager.featureUnlocked("wildmining")) {
                Tools.printMenuOption(player, "/wilderness", "mine " + "(" + Tools.formatCurrency(StaticValues.MINING_PRICE) + ")");
            }
