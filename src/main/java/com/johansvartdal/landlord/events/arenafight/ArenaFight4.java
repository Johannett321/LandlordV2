...
public class ArenaFight4 extends ArenaFightEvent {
    ...
    public Wave[] getWaves() {
        ...
        wave4.addWaveStep(new WaveStep(EntityType.WITHER, mult, Tools.secToTicks(1), new Location[]{Ports.PORT_4}));
        ...
        wave5.addWaveStep(new WaveStep(EntityType.WITHER, 3*mult, Tools.secToTicks(2), new Location[]{Ports.PORT_4}));
