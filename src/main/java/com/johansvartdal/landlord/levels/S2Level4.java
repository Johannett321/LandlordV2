...
public class S2Level4 extends Level{
    ...
    public ArrayList<ItemStack> getRequiredItemsForNextLevel() {
        ...
        requiredItems.add(new ItemStack(Material.BOOK, 32 * Main.properties.getNumberOfPlayers()));
        ...
        requiredItems.add(new ItemStack(Material.SUGAR, 206 * Main.properties.getNumberOfPlayers()));
        requiredItems.add(new ItemStack(Material.BEETROOT, 128 * Main.properties.getNumberOfPlayers()));
        ...
        requiredItems.add(new ItemStack(Material.HONEY_BOTTLE, 16 * Main.properties.getNumberOfPlayers()));
        requiredItems.add(new ItemStack(Material.BASALT, 16 * Main.properties.getNumberOfPlayers()));
