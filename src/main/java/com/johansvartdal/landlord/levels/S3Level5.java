...
public class S3Level5 extends Level{
    ...
    public void justUpgraded() {
        God.speak(LangDict.getString("levelBooks.season3.level5.godSpeak"));
    }
    ...
    @Override
    public Book getBook() {
        Book book = new Book("S3L5");
        book.addPage(LangDict.getString("levelBooks.season3.level5.page1"));
        book.addPage(LangDict.getString("levelBooks.season3.level5.page2"));
